<footer>
							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="hidden-xs">
										<i class="fa fa-map-marker"></i> <span>Rua 13A, 329 - Vila Alemã<br/>Rio Claro, SP - CEP 11065240</span>
									</address>

									<p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i>(19) 3325-5253</a></p>
			...
			<div class="row row-cinza-escuro">
				...
				<div class="container copyright-mobile">
					...
					<p class="pull-left">Copyright © INOVE 2017. All rights reserved.</p>
					<p class="pull-right text-roxo">Created by INOVE</p>
